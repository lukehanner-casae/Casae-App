...
import TenantPipelinePage from '@/pages/TenantPipelinePage'
    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        <Route element={<AppShell />}>
          ...
          <Route path="pipeline" element={<TenantPipelinePage />} />
          <Route path="properties" element={<PropertiesPage />} />
          <Route path="properties/:id" element={<PropertyDetailPage />} />
          <Route path="lodgers" element={<LodgersPage />} />
          <Route path="lodgers/:id" element={<LodgerProfilePage />} />
          {/* Deprecated for the occupancy pivot — reachable by URL, hidden from nav. */}
